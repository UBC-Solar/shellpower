...
// expose for debugging
        ...
        private void BuildMeshBuffers()
        {
            ...
            _vertexCount = vcount;                               // <-- track this
            ...
            _meshIndexCount = triCount * 3;                      // length of index array, not triangle count
            ...
            // aPos @ location 0  (pos|norm interleaved: 6 floats per vertex)
            GL.EnableVertexAttribArray(0);
